...
function StudyLeaveDetailsVC() {
    ...
    var instruction ="Forward To Register";
    useEffect(() => {
    ...
    const handleForwardOfVC= async (e) => {
        e.preventDefault();
        if (formData) {
          ...
          const updateData = {
            ...
            le_comment:registrarComment, // Correct reference
            le_evaluation_time: currentTime,
            le_status: "approved",
          };
    
          
 var evaluation_type_update ="Registrar Final Approval";
            ...
            {formData && (
                <div className="form-container">
                    ...
                    <form className="leave-form">
                        ...
                        <div className="form-group">
                            <div className="input-wrapper">
                                <label htmlFor="registrar_comment">Vice Chancellor's Comment:</label>
                            </div>
                            <div className="input-wrapper">
                                <textarea
...
export default  StudyLeaveDetailsVC;
