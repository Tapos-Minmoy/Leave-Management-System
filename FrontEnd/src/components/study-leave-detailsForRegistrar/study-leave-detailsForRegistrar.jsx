...
function StudyLeaveDetailsForRegistrar() {
  ...
  const handleForwardOfRegistrar = async () => {
    ...
    if (formData) {
      ...
      const addData = {
        leave_id,
        evaluation_type: evaluation_type==="Register Primary Approval"?
        "Higher Study Primary Approval":"Higher Study Final Approval",
        applicant_id: formData.applicant_id,
        le_comment: "",
        le_evaluation_time: currentTime,
        le_status: "Pending"
      ...
      {formData && (
        <div className="form-container">
          ...
          <form className="leave-form">
            ...
            <div className="form-group">
              <div className="input-wrapper">
                <label htmlFor="registrar_comment">Chairman's Comment:</label>
              </div>
              <div className="input-wrapper">
                <textarea
