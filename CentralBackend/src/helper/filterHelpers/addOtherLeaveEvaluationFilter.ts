...
export function addOtherLeaveEvaluationFilter(
  req: Request,
  query: SelectQueryBuilder<Database, "Other_Leave_Evaluation", {}>,
) {
  if (
    ...
    query = query.where(
      "Other_Leave_Evaluation.evaluation_type",
      "=",
  ...
  if (
    ...
    query = query.where(
      "Other_Leave_Evaluation.le_status",
      "=",
  ...
  if (
    ...
    query = query.where(
      "Other_Leave_Evaluation.leave_id",
      "=",
  ...
  if (
    ...
    query = query.where(
      "Other_Leave_Evaluation.applicant_id",
      "=",
